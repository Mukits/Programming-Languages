...
public class RemoveItemFXMLTest extends AbstractFXMLTest {
	...
	public RemoveItemFXMLTest() {
		super(new File("resources/uk/ac/aston/oop/javafx/prep/RemoveItem.fxml"));
	}
	...
	public void middleLabel() {
		...
		Element insets = e.element("VBox.margin").element("Insets");
	...
	public void hbox() {
		...
		Element eInsets = e.element("padding").element("Insets");
